...
class REFER:
    def __init__(self, dataset='refcoco', splitBy='unc'):
        ...
        self.DATA_DIR = osp.join(Data_path, dataset)
        if dataset in ['refcoco', 'refcoco+', 'refcocog']:
            self.IMAGE_DIR = osp.join(Data_path, 'COCOtrain2014')
        elif dataset == 'refclef':
            self.IMAGE_DIR = osp.join(Data_path, 'saiapr_tc-12')
        else:
...
if __name__ == '__main__':
    # refer = REFER(dataset='refcocog', splitBy='umd')
